export function selectNextNthElement(el: HTMLInputElement| null): HTMLInputElement | null {
...
export function selectNextSibling(el: HTMLInputElement|null): HTMLInputElement | null {
  const nextEl = el?.parentElement?.nextElementSibling?.firstElementChild;
  return (nextEl instanceof HTMLInputElement) ? nextEl : null;
}

export function selectPrevNthElement(el: HTMLInputElement|null): HTMLInputElement | null {
...
export function selectPrevSibling(el: HTMLInputElement|null): HTMLInputElement | null {
